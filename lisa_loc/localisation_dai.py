...
class Localisation(Node):
    def __init__(self):
        ...
        #dai 2
        self.lidar_data_folder = "/home/lisa/datasets/dai2/velodyne_points/data_pcd/"
        self.gps_data_folder = "/home/lisa/datasets/dai2/oxts/"
    ...
    def main(self):
        for window_index in range(self.lidar_buffer_size - 1, self.total_lidar_frames):
            ...
            for _ in range(0, 5):
                # if self.dai == True:
                result = small_gicp.align(pcd_map, non_ground_filtered, registration_type="ICP",  init_T_target_source= self.T_world_lidar , max_correspondence_distance=1, max_iterations=1000)
                # else:
